...
- **[docs/SKILL.md](docs/SKILL.md)** — a Claude Skill for AI agents writing code against this library; copy it into your own project's `.claude/skills/` for accurate, hallucination-resistant guidance.
